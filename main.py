...
with tab1:
    ...
    <style>
        ...
        .tooltip {{
            ...
            position: absolute;
            z-index: 1;
            left: 100%; /* Position the tooltip to the right of the rectangle */
            top: 50%;
            margin-top: -20px; /* Center the tooltip vertically */
            margin-left: 10px; /* Add space between the rectangle and the tooltip */
            opacity: 0;
            transition: opacity 0.3s;
        }}
        
        .vertical-rectangle:hover .tooltip {{
            visibility: visible;
            opacity: 1;
            width: 200px;
        }}
